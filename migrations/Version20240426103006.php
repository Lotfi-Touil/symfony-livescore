 ...
 */
final class Version20240426103006 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE score ADD score_type_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_32993751A4C4A907');
        $this->addSql('ALTER TABLE score DROP score_type_id');
    }
}
